...
boolean IfxGtm_Tom_Pwm_init(IfxGtm_Tom_Pwm_Driver *driver, const IfxGtm_Tom_Pwm_Config *config)
{
    ...
    IfxGtm_Tom_Tgc_enableChannelUpdate(driver->tgc[0], config->tomChannel, FALSE); //Disable the update of the action register
    ...
    {
        IfxGtm_Tom_Tgc_enableChannelUpdate(driver->tgc[0], config->tomChannel, TRUE);   //Enable the update of the action register
    }
